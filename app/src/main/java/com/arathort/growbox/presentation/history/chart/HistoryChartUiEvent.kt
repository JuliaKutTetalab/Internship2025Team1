...
sealed interface HistoryChartUiEvent {
    data object OnDailyGraphicSelected : HistoryChartUiEvent
    data object OnWeekGraphicSelected : HistoryChartUiEvent
    data object OnMonthlyGraphicSelected : HistoryChartUiEvent

    data object OnReturnButtonClick : HistoryChartUiEvent
}
